...
public class CubeRefinado {
    ...
    public CubeRefinado(Context context) {
        ...
        InputStream is = context.getResources().openRawResource(R.raw.peperrito);
        ...
        for (String face : facesList) {
            ...
            float value1 = 0.454901961f;// r.nextFloat();//random.nextFloat();
            float value2 = 0.341176471f;// r.nextFloat();//random.nextFloat();
            float value3 = 0.250980392f;// r.nextFloat();//random.nextFloat();
